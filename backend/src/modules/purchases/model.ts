...
export namespace PurchaseModel {
  ...
  export const activateCardBody = t.Object({
    physicalCardSerialNumber: t.String({
      minLength: 1,
      description: "Serial number kartu fisik yang diberikan ke customer. Harus sesuai dengan kartu yang di-assign saat purchase.",
  ...
  export const swapCardBody = t.Object({
    correctCardSerialNumber: t.String({
      minLength: 1,
      description: "Serial number kartu yang benar untuk mengganti kartu yang salah. Kartu harus berstatus IN_STATION dan kategori harus sama.",
