    ...
    paths: {
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    redeemType: { type: "string", enum: ["SINGLE", "ROUNDTRIP"] },
      ...
      "/redeem/{id}": {
        get: {
          ...
          responses: {
            200: { description: "Redeem transaction detail fetched successfully" },
        ...
        delete: {
          ...
          responses: {
            200: { description: "Redeem transaction deleted and quota restored" },
            404: { description: "Not found" },
            500: { description: "Internal server error" }
          }
        }
      ...
      "/redeem/export": {
        get: {
          ...
          parameters: [
            ...
            { name: "format", in: "query", schema: { type: "string", enum: ["csv", "xlsx", "pdf", "jpg"] } }
          ],
          responses: {
            ...
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  properties: {
                    imageBase64: { type: "string", description: "Base64-encoded image (JPEG/PNG)" },
                    mimeType: { type: "string", description: "Optional mimeType override (image/jpeg or image/png)" }
                  },
