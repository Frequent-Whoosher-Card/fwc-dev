      ...
      if (response.success) {
        if (showPendingOnly) {
          ...
          const pending = response.data.items.filter(
            (p: Purchase) => p.activationStatus === "PENDING"
          );
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button
          onClick={() => router.push("/dashboard/petugas/transaksi/create")}
        >
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-amber-700 mt-1">
              Ada purchase yang perlu diaktivasi. Klik tombol di bawah untuk
              melihat dan aktivasi.
            </p>
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow>
                ...
                >
                  {showPendingOnly
                    ? "Tidak ada purchase yang menunggu aktivasi"
                ...
                <TableRow key={purchase.id}>
                  ...
                  <TableCell>
                    <div className="font-mono text-sm">
                      {purchase.card.assignedSerialNumber ||
                        purchase.card.serialNumber}
                    </div>
                  ...
                  <TableCell>
                    {getStatusBadge(purchase.activationStatus)}
                  </TableCell>
                  <TableCell>
                    <div className="flex gap-2">
                      {purchase.activationStatus === "PENDING" && (
                        <>
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              setSwapModal({ open: true, purchase })
                            }
                          >
                          ...
                          <Button
                            ...
                            variant="destructive"
                            onClick={() =>
                              setCancelModal({ open: true, purchase })
                            }
                          >
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Scan atau input serial number kartu fisik yang diberikan ke
              customer
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
              <Label className="text-sm font-medium">
                Kartu yang di-assign:
              </Label>
              <p className="text-lg font-mono font-bold">
                {activateModal.purchase?.card.assignedSerialNumber ||
                  activateModal.purchase?.card.serialNumber}
              </p>
            </div>
            <div>
              <Label htmlFor="physicalSerial">
                Serial Number Kartu Fisik *
              </Label>
              <Input
                id="physicalSerial"
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-lg font-mono">
                {swapModal.purchase?.card.assignedSerialNumber ||
                  swapModal.purchase?.card.serialNumber}
              </p>
            </div>
            <div>
              <Label htmlFor="correctSerial">
                Serial Number Kartu Pengganti *
              </Label>
              <Input
                id="correctSerial"
          ...
          <div className="space-y-4">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                <strong>Perhatian:</strong> Purchase yang sudah dibatalkan tidak
                dapat diaktivasi kembali.
              </p>
            </div>
            <div>
