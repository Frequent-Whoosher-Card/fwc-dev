...
const superadminMenuItems = [
  ...
  },
  {
    title: "Redeem Kuota",
    icon: IdCard,
    href: "/dashboard/superadmin/redeemkuota",
  },
  {
    title: "Stock Kartu",
    icon: CreditCard,
...
const petugasMenuItems = [
  ...
  { title: "Stock", icon: CreditCard, href: "/dashboard/petugas/stock" },
  {
    title: "Redeem Kuota",
    icon: IdCard,
    href: "/dashboard/petugas/redeemkuota",
  },
  { title: "Transaksi", icon: Receipt, href: "/dashboard/petugas/transaksi" },
  {
    title: "Card Swap",
    icon: ArrowLeftRight,
    href: "/dashboard/petugas/card-swap",
    children: [
      {
        title: "Buat Request",
        href: "/dashboard/petugas/card-swap",
      ...
      {
        title: "Eksekusi Swap",
        href: "/dashboard/petugas/card-swap-execute",
        icon: ArrowLeftRight,
      },
    ],
  },
...
const supervisorMenuItems = [
  ...
  {
    title: "Card Swap Approval",
    icon: ArrowLeftRight,
    href: "/dashboard/supervisor/card-swap-approval",
  },
];
