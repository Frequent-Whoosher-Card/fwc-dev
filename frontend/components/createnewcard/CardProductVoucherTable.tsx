                ...
                <td className="px-4 py-3 text-center">
                  <div className="flex justify-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        router.push(
                          `/dashboard/superadmin/createnewcard/voucher/${item.id}/edit`,
                        )
                      }
                      className="rounded-md border border-blue-500 px-3 py-1 text-xs text-blue-600 transition-colors duration-200 hover:bg-blue-500 hover:text-white"
                    >
                      Edit
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-md border border-[#8D1231] px-3 py-1 text-xs text-[#8D1231] transition-colors duration-200 hover:bg-[#8D1231] hover:text-white"
                    >
                      Hapus
                    </button>
                  </div>
