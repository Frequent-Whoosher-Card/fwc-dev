...
interface SuccessModalProps {
  ...
  confirmText?: string; // ⬅️ TAMBAHKAN INI
}

export default function SuccessModal({
  open,
  title = "Data Saved",
  message = "The new user’s data has been saved to the database",
  data,
  onClose,
  onConfirm,
  confirmText = "OK", // ⬅️ INI YANG KAMU LUPA
}: SuccessModalProps) {
  /* ======================
     ESC + SCROLL LOCK
  ====================== */
        ...
        {isReviewMode && (
          <div className="mt-6 max-h-[360px] overflow-y-auto rounded-lg border border-gray-300">
            ...
            <div className="grid grid-cols-2 bg-[#8D1231] text-white text-sm font-bold border-b">
              ...
              <div className="px-4 py-3">Data Penumpang</div>
            </div>
